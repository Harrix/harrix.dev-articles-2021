...
При запуске могут спросить про то стоит ли открывать файлы C++ нашей программой:

![Запрос на открытие файлов программой Code::Blocks](img/install_08.png)

_Рисунок 9 — Запрос на открытие файлов программой Code::Blocks_

![Открытая программа Code::Blocks](img/code-blocks.png)

_Рисунок 10 — Открытая программа Code::Blocks_
...
_Рисунок 11 — Создание пустого файла_
...
_Рисунок 12 — Пункт меню для сохранения файла_
...
_Рисунок 13 — Сохранение файла кода_

![Программа Code::Blocks с пустым сохраненным файлом](img/new-project_04.png)

_Рисунок 14 — Программа Code::Blocks с пустым сохраненным файлом_
...
_Рисунок 16 — Компиляция и запуск программы_
...
_Рисунок 19 — Код программы сложения двух чисел_

Сохраните файл:

![Сохранение файла исходного кода](img/new-project_02.png)

_Рисунок 20 — Сохранение файла исходного кода_
...
_Рисунок 22 — Компиляция и запуск программы_
