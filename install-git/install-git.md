...
Раньше начальная [ветка](https://git-scm.com/book/ru/v2/Ветвление-в-Git-О-ветвлении-в-двух-словах) в Git называлась `master`. Но теперь в GitHub она называется `main`, так как `master` по своему смыслу означает рабовладельцев. Выбираем начальное название ветки, как `main`:
...
_Рисунок 16 — Процесс установки_

![Окончание установки](img/install-git_16.png)

_Рисунок 17 — Окончание установки_
...
_Рисунок 18 — Главная страница сайта GitHub_
...
_Рисунок 21 — Вход в уже существующую учетную запись_

И теперь вы в своем профиле:

![Вход в уже существующую учетную запись](img/github_05.avif)

_Рисунок 22 — Вход в уже существующую учетную запись_
...
_Рисунок 23 — Создание нового репозитория_
...
_Рисунок 24 — Настройка проекта_
...
_Рисунок 25 — Настройка проекта_
...
_Рисунок 26 — Пример файла `README.md`_
...
_Рисунок 27 — Пример выбора файла .gitignore_
...
_Рисунок 29 — Новый репозиторий_
...
_Рисунок 30 — Скачивание установщика_
...
_Рисунок 31 — Авторизация в GitHub_
...
_Рисунок 32 — Ввод логи н и пароля GitHub_
...
_Рисунок 33 — Авторизация GitHub Desktop_
...
_Рисунок 34 — Окончание установки_

![Открытый GitHub Desktop](img/install-github-desktop_06.avif)

_Рисунок 35 — Открытый GitHub Desktop_
...
_Рисунок 36 — Пункт меню с клонированием проекта_
...
_Рисунок 40 — Переключение между репозиториями_
...
_Рисунок 41 — Переключение между репозиториями_
...
_Рисунок 42 — Тестовая картинка_

![Файлы в папке с проектом](img/work_01.png)

_Рисунок 43 — Файлы в папке с проектом_
...
_Рисунок 44 — Изменения в проекте_
...
_Рисунок 46 — История коммитов с первым коммитом_
...
_Рисунок 47 — Отправка коммита на сервер_
...
_Рисунок 48 — Репозиторий на сайте с первым коммитом_
