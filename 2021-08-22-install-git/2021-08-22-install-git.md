...
Для работы с Git иногда требуется из-под консоли Git запускать текстовой редактор. И тут можно выбрать, какой текстовой редактор будет запускаться при этом. Если у вас ничего особенного нет, то выбирайте обычный блокнот `Use Notepad as Git's default editor`. У меня же стоит [Visual Studio Code Insiders](/blog/2019/install-vscode/), поэтому я выбираю выделенный синим пункт:
